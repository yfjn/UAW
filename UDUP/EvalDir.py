...
if __name__=="__main__":
    patch_path=os.path.join(os.path.abspath('.')[:-4],"result_save","size=100_step=2_eps=70_PI=False","advtorch","advpatch_60")
    model_name="CRAFT"
    img_path=os.path.join(os.path.abspath('.')[:-4],"AllData","test_color")
    gt_path = os.path.join(os.path.abspath('.')[:-4], "AllData","test_color_gt")
    save_path = os.path.join(os.path.abspath('.')[:-4],'result_save','test_color')
    # print(gt_path)
