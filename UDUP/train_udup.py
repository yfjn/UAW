...
def parse_args():
    ...
    parser.add_argument('--is_PI', type=bool, default=False, help='Whether to use PI mode (freeze STD)')
    ...
    parser.add_argument('--model_name', type=str, default='EasyOCR', choices=['CRAFT', 'EasyOCR'], help='Model name for training')
...
if __name__ == '__main__':
    ...
    log_dir = os.path.join(abspath, f'results/UDUP_Mylog/{args.model_name}')
    result_dir = os.path.join(abspath, f'results/UDUP_results/{args.model_name}')
