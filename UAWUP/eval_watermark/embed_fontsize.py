...
if __name__ == "__main__":
    ...
    save_dir = 'eval_watermark/fontsize/awu'
    ...
    awu_path = "eval_watermark/fontsize/awu/awu.png"  # 对抗水印底纹路径
    ...
    for fontsize in fontsize_eval:
        ...
        output_dir = "eval_watermark/fontsize/awti_{}".format(fontsize)  # 对抗水印文本图像路径
        ...
        for i in tqdm(range(100)):
            ...
            text_image_t = generate_text_image(width, height, s, font_size=fontsize, font_color=None, device=device)
