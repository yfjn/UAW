...
def parse_args():
    ...
    parser.add_argument('--config', default='TCM/configs/textdet/dbnet/clip_db_r50_fpnc_prompt_gen_vis_1200e_ft_gen_ic15_adam_taiji.py', help='Train config file path.')
    parser.add_argument('--work-dir', default='TCM', help='The dir to save logs and models.')
