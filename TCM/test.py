...
def parse_args():
    ...
    parser.add_argument('--config', default='TCM/clip_db_r50_fpnc_prompt_gen_vis_1200e_ft_gen_ic15_adam_taiji_0120_184718/clip_db_r50_fpnc_prompt_gen_vis_1200e_ft_gen_ic15_adam_taiji.py', help='Test config file path.')
    parser.add_argument('--checkpoint', default='TCM/clip_db_r50_fpnc_prompt_gen_vis_1200e_ft_gen_ic15_adam_taiji_0120_184718/best_0_icdar2015_test_hmean-iou:hmean_epoch_45.pth', help='Checkpoint file.')
    ...
    parser.add_argument('--format-only', action='store_true', help='Format the output results without performing evaluation. It is useful when you want to format the results to a specific format and submit them to the test server.')
    parser.add_argument('--eval', type=str, nargs='+', help='The evaluation metrics, which depends on the dataset, e.g., "bbox", "seg", "proposal" for COCO, and "mAP", "recall" for PASCAL VOC. hmean-iou for det_ocr')
    parser.add_argument('--show', action='store_true', help='Show results.')
    parser.add_argument('--show-with-score-map', action='store_true', help='Format the output results without performing evaluation. It is used for showing combined score map, pred_text_mask, pred and gt')
    parser.add_argument('--show-dir', default='TCM/results', help='Directory where the output images will be saved.')
    ...
    parser.add_argument('--tmpdir', help='The tmp directory used for collecting results from multiple workers, available when gpu-collect is not specified.')
    ...
    parser.add_argument('--launcher', choices=['none', 'pytorch', 'slurm', 'mpi'], default='none', help='Options for job launcher.')
